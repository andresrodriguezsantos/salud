...
/**
 * This is the model class for table "opt_agudezavisual_concorreccion".
 *
 * @property string $id
 ...
 */
class OptAgudezavisualConcorreccion extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'opt_agudezavisual_concorreccion';
    }
    ...
    {
        return [
            [['vl_derecho_snellen', 'vl_derecho_logmar', 'vl_izquierdo_snellen',
                'vl_izquierdo_logmar', 'vl_ambos_snellen', 'vl_ambos_logmar', 'vp_derecho',
                'vp_izquierdo', 'vp_ambos', 'opt_agudezavisual_id'], 'required','on'=>'create'],
